#!/usr/bin/python3
"""Defines a class Rectangle with width, height, instance counter,
string representations, area comparison, and square creation.
"""
...
class Rectangle:
    ...
    def __str__(self):
        """Return the rectangle represented with 'print_symbol' characters."""
        if self.__width == 0 or self.__height == 0:
            return ""
